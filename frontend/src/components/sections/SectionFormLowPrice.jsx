      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-12  clearfix">
            ...
            <div className="col-md-12 zakaz_lowprice clearfix">
              <div className="razmetka1">
                <div className="low_name">
                  <input id="low_name" className="v_name" type="text" placeholder="Ваше имя" value={name} onChange={(e) => setName(e.target.value)} />
                </div>
              </div>
              <div className="razmetka1">
                <div className="low_tel">
                  <input id="low_tel" className="v_tel" type="tel" inputMode="numeric" placeholder="8 (999) 123-45-67" value={phone} onChange={(e) => setPhone(formatPhoneInput(e.target.value))} />
                </div>
              </div>
        ...
        <div className="prav-info clearfix">Вписывая телефон, вы подтверждаете свое совершеннолетие, соглашаетесь на обработку персональных данных в&nbsp;соответствии с

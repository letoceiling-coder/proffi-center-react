...
/** Блок «Почему выбирают нас» — только факты из контента сайта */
export const whyUsData = [
  {
    value: '13 лет',
    label: 'на рынке',
    text: 'Proffi Center работает с 2013 года. За это время мы установили тысячи натяжных потолков и накопили опыт для проектов любой сложности.',
  },
  {
    value: '20+ лет',
    label: 'гарантия',
    text: 'Используемые материалы и технология монтажа обеспечивают срок службы потолка более 20 лет без потери вида и характеристик.',
  },
  {
    value: '1 день',
    label: 'монтаж',
    text: 'Профессиональные мастера устанавливают потолок за один рабочий день — вы получаете готовый результат без долгого ожидания.',
  },
  {
    value: 'Класс А+',
    label: 'экологичность',
    text: 'Полотна соответствуют санитарным требованиям и правилам пожарной безопасности. Все необходимые сертификаты в наличии.',
  },
  {
    value: '0%',
    label: 'рассрочка',
    text: 'Беспроцентная рассрочка от 6 месяцев до 3 лет без первоначального взноса и переплаты. Оформление на месте, без банка.',
  },
  {
    value: 'Бесплатно',
    label: 'замер и выезд',
    text: 'Инженер компании приедет в удобное время, сделает точный замер и рассчитает стоимость прямо у вас дома. Договор — тоже на месте.',
  },
];

/** Блок «Как проходит монтаж» — 4 шага */
export const howItWorksData = {
  steps: [
    {
      title: 'Оставьте заявку',
      text: 'Позвоните или заполните форму — замерщик приедет в удобное для вас время. Выезд бесплатный, без обязательств.',
    },
    {
      title: 'Замер и договор',
      text: 'Инженер снимет точные размеры, поможет выбрать фактуру и цвет, рассчитает итоговую стоимость. Договор оформляется на месте.',
    },
    {
      title: 'Изготовление полотна',
      text: 'Потолок изготавливается на собственном производстве по точным меркам. Это позволяет держать цены ниже, чем у посредников.',
    },
    {
      title: 'Монтаж за 1 день',
      text: 'Мастера устанавливают потолок аккуратно, убирают за собой мусор. По завершении вы принимаете работу и оплачиваете результат.',
    },
  ],
  cta: { text: 'Записаться', href: '#' },
};

/** Блок FAQ — вопросы и ответы на основе реального контента сайта */
export const faqData = [
  {
    q: 'Сколько стоит натяжной потолок?',
    a: 'Стоимость зависит от площади и типа полотна. Матовый и глянцевый потолок — от 99 рублей за м², тканевый — от 950 рублей за м², многоуровневые конструкции — от 1 990 рублей за м². Точный расчёт сделает замерщик бесплатно.',
  },
  {
    q: 'Сколько времени занимает установка?',
    a: 'Как правило, монтаж занимает один рабочий день. Мастера приезжают в согласованное время, устанавливают потолок и убирают после себя. Для крупных или многоуровневых конструкций сроки обсуждаются индивидуально.',
  },
  {
    q: 'Нужна ли предоплата?',
    a: 'Нет. Компания Proffi Center работает без предоплат и авансов. Оплата производится только по факту выполненных работ — наличными или безналичным расчётом.',
  },
  {
    q: 'Какая гарантия на натяжной потолок?',
    a: 'Срок службы натяжного потолка при правильной эксплуатации — более 20 лет. Используемые материалы соответствуют всем санитарным требованиям и имеют сертификаты качества.',
  },
  {
    q: 'Безопасны ли натяжные потолки для здоровья?',
    a: 'Да. Все применяемые материалы соответствуют классу экологичности А+ — это высший уровень безопасности. Потолки безопасны для взрослых, детей и аллергиков.',
  },
  {
    q: 'Можно ли установить потолок при низких потолках?',
    a: 'Можно. Натяжной потолок опускает высоту примерно на 3–5 см. При этом правильно подобранное глянцевое полотно визуально увеличивает высоту помещения. Наш специалист подберёт оптимальный вариант на замере.',
  },
];
